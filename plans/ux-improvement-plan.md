...
### [x] 2a. PyPI (Already live — improve discoverability)
...
### [x] 2d. Binary Releases (GitHub Actions)
...
### [x] 3a. `copium init` — The Missing Command
...
### [x] 3b. `copium remove` / `copium uninstall` — Documented Clean Removal
