...
Four key components:
1. Tool Injection: Proxy injects copium_retrieve tool into requests
...
try:
    from .mcp_server import CopiumMCPServer, create_ccr_mcp_server

    MCP_SERVER_AVAILABLE = True
except ImportError:
    CopiumMCPServer = None  # type: ignore
