...
When the LLM calls copium_retrieve, this handler:
...
class CCRResponseHandler:
    ...
    Example flow:
    1. LLM response contains: tool_use(copium_retrieve, hash=abc123)
    ...
    def has_ccr_tool_calls(
        ...
        Returns:
            True if response contains copium_retrieve tool calls.
        """
        ...
        while rounds < self.config.max_retrieval_rounds:
            ...
            if other_calls:
                logger.warning(
                    ...
                    "alongside copium_retrieve. Cannot create a valid continuation "
