"""Base class for copium learn plugins.
...
class LearnPlugin(ABC):
    ...
    Plugins are discovered automatically from copium.learn.plugins.*
    or via ``copium.learn_plugin`` entry points for external packages.
