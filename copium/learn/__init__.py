"""Copium Learn — offline session learning for coding agents.
...
Built-in plugins are auto-discovered from copium.learn.plugins.*.
External plugins register via the ``copium.learn_plugin`` entry point.
"""
