...
# Marker delimiters for Copium-managed sections
_MARKER_START = "<!-- copium:learn:start -->"
_MARKER_END = "<!-- copium:learn:end -->"
...
def _build_section(recommendations: list[Recommendation]) -> str:
    ...
    lines = [
        ...
        f"*Auto-generated by `copium learn` on {now} — do not edit manually*",
        "",
    ]
...
def extract_marker_block(file_content: str) -> str | None:
    """Return the raw text of the copium:learn marker block, or None.
