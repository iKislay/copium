...
Mirrors the Anthropic OAuth usage API response exactly, including:
  ...
  - Copium contribution: tokens conserved by compression, CLI filtering, cache
...
# ---------------------------------------------------------------------------
# Copium contribution estimate
# ---------------------------------------------------------------------------


@dataclass
class CopiumContribution:
    """Tokens conserved within the current 5h window by Copium's layers.
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "raw_without_copium": self.raw_without_copium(),
...
class SubscriptionState:
    ...
    contribution: CopiumContribution = field(default_factory=CopiumContribution)
