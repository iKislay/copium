...
come from the environment at copium start-up.
...
class _CopilotQuotaTracker(QuotaTracker):
    ...
    Implements :class:`~copium.subscription.base.QuotaTracker` so it can be
    registered with the :class:`~copium.subscription.base.QuotaTrackerRegistry`.
    ...
    async def _poll_loop(self) -> None:
        ...
        while not self._stop_event.is_set():
            ...
            try:
                ...
                # note in copium/subscription/tracker.py:_poll_loop.
