"""rtk (Rust Token Killer) integration for Copium.

rtk compresses CLI output (test results, git diffs, log dumps) before it
enters the LLM context window. Copium downloads and manages the rtk binary.
"""
...
def _managed_rtk_candidates() -> list[Path]:
    """Return known Copium-managed rtk binary paths."""
