"""Copium Backends - API translation layers for different LLM providers.
...
Usage:
    # LiteLLM backend
    copium proxy --backend litellm-bedrock --region us-west-2

    # any-llm backend
    copium proxy --backend anyllm --anyllm-provider openai
"""
