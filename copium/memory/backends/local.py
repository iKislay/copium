"""Local backend adapter for Copium's hierarchical memory system.
...
from copium.memory.adapters.graph_models import Entity, Relationship, Subgraph
...
class LocalBackend:
    ...
    async def _ensure_initialized(self) -> None:
        ...
        if not self._initialized:
            ...
            from copium.memory.config import EmbedderBackend
    ...
    async def text_search(
        ...
        from copium.memory.ports import TextFilter
