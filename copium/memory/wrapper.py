"""Memory wrapper - the main API for Copium Memory.
...
from copium.memory.inline_extractor import (
...
class MemoryWrapper:
    ...
    def __init__(
        ...
        client: Any,
        user_id: str,
        db_path: str | Path = "copium_memory.db",
        top_k: int = 5,
...
def with_memory(
    ...
    **kwargs: Any,
    ...
    Args:
        ...
        user_id: User identifier for memory isolation
        db_path: Path to SQLite database (default: copium_memory.db)
