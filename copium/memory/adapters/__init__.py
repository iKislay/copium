"""Memory adapters for Copium's hierarchical memory system.
...
from copium.memory.adapters.sqlite_graph import SQLiteGraphStore
...
def __getattr__(name: str) -> type | bool:
    ...
    if name == "SQLITE_VEC_AVAILABLE":
        ...
        if _SQLITE_VEC_AVAILABLE is None:
            from copium.memory.adapters.sqlite_vector import is_sqlite_vec_available
