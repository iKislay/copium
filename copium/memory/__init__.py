"""Copium Memory - Simple, zero-config memory for AI applications.

Quick Start (No Docker Required):
    from copium.memory import Memory
...
Advanced Usage - LLM Wrapper:
    ...
    from copium.memory import with_memory
...
Advanced Usage - Tool-based:
    from openai import OpenAI
    from copium.memory import with_memory_tools, LocalBackend
...
# Graph adapters
# =============================================================================
from copium.memory.adapters.graph import InMemoryGraphStore
...
# =============================================================================
# Memory Bridge (markdown <-> Copium bidirectional sync)
# =============================================================================
from copium.memory.bridge import ImportStats, MemoryBridge, SyncStats
...
# Factory
# =============================================================================
from copium.memory.factory import create_memory_system

# =============================================================================
# Data models (internal)
# =============================================================================
from copium.memory.models import Memory as MemoryModel
from copium.memory.models import ScopeLevel

# =============================================================================
# Protocol interfaces (ports)
# =============================================================================
from copium.memory.ports import (
    # Core protocols
    Embedder,
    # Graph dataclasses
    Entity,
...
# =============================================================================
from copium.memory.system import MemoryBackend, MemorySystem

# =============================================================================
# Memory tools for LLM function calling
# =============================================================================
from copium.memory.tools import (
    MEMORY_TOOLS,
...
# =============================================================================
from copium.memory.wrapper import MemoryWrapper, with_memory

# =============================================================================
# Tool-based wrapper for LLM clients
# =============================================================================
from copium.memory.wrapper_tools import MemoryToolsWrapper, with_memory_tools
...
def __getattr__(name: str) -> type:
    ...
    if name == "Mem0Backend":
        if _Mem0Backend is None:
            from copium.memory.backends.mem0 import Mem0Backend
    ...
    if name == "DirectMem0Adapter":
        if _DirectMem0Adapter is None:
            from copium.memory.backends.direct_mem0 import DirectMem0Adapter
    ...
    if name == "DirectMem0Config":
        if _DirectMem0Config is None:
            from copium.memory.backends.direct_mem0 import Mem0Config as DirectMem0Config
