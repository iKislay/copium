...
Writers convert Copium memory entries into agent-specific file formats.
...
# Marker delimiters for Copium-managed sections (matches learn/writer.py)
MARKER_START = "<!-- copium:memory:start -->"
MARKER_END = "<!-- copium:memory:end -->"
