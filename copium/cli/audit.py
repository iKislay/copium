...
def audit_reads_cmd(
    ...
    Examples:
        copium audit-reads
        copium audit-reads --path /var/transcripts --format json
        copium audit-reads --codex
    """
    import json as _json

    from copium.audit.reads import audit_reads, render_text
    ...
    if codex_mode:
        ...
        from copium.audit.codex import audit_codex, render_codex_text
    ...
    if simulate_maturation:
        from copium.audit.maturation import render_sim_text
        from copium.audit.maturation import simulate_maturation as run_sim
