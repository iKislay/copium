...
Automatically detects the correct Copium provider based on the Agno model type.
"""
...
# Mapping from Agno model class names to Copium providers
...
def get_copium_provider(agno_model: Any) -> Provider:
    """Get the appropriate Copium provider for an Agno model.
    ...
    Example:
        ...
        provider = get_copium_provider(model)  # Returns OpenAIProvider
    """
