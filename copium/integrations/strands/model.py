"""Strands SDK model wrapper for Copium optimization.

This module provides CopiumStrandsModel, which wraps any Strands model
...
from copium import CopiumConfig  # noqa: E402
from copium.providers import OpenAIProvider  # noqa: E402
from copium.transforms import TransformPipeline  # noqa: E402

from .providers import get_copium_provider, get_model_name_from_strands  # noqa: E402
...
class CopiumStrandsModel(Model):  # type: ignore[misc]
    """Strands model wrapper that applies Copium optimizations.
    ...
    def __init__(
        ...
        """Initialize CopiumStrandsModel.

        Args:
            wrapped_model: The Strands model to wrap (e.g., BedrockModel, OpenAIModel)
            config: Optional CopiumConfig for optimization settings
            auto_detect_provider: Whether to auto-detect the Copium provider
        ...
        self.copium_config = config or CopiumConfig()
        ...
        self._copium_provider: Any = None
    ...
    def _convert_messages_to_openai(self, messages: list[Any]) -> list[dict[str, Any]]:
        """Convert Strands messages to OpenAI format for Copium.
    ...
    async def stream(
        ...
        **kwargs: Any,
        ...
        logger.info(
            f"Copium optimized (stream): {metrics.tokens_before} -> "
    ...
    async def structured_output(
        ...
        **kwargs: Any,
        ...
        """Generate structured output with Copium optimization.
        ...
        logger.info(
            f"Copium optimized (structured_output): {metrics.tokens_before} -> "
            f"{metrics.tokens_after} tokens ({metrics.savings_percent:.1f}% saved)"
        )
...
def optimize_messages(
    ...
    Example:
        from copium.integrations.strands import optimize_messages
