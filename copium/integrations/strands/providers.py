...
Automatically detects the correct Copium provider based on the Strands model type.
"""
...
# Mapping from Strands model class names to Copium providers
...
def get_copium_provider(model: Any) -> Provider:
    """Get the appropriate Copium provider for a Strands model.
    ...
    Returns:
        Appropriate Copium Provider instance.

    Example:
        from strands.models import BedrockModel
        from copium.integrations.strands.providers import get_copium_provider
