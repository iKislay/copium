...
This module provides CopiumChatMessageHistory, a wrapper for any LangChain
...
Example:
    ...
    compressed_history = CopiumChatMessageHistory(base_history)
...
if TYPE_CHECKING:
    from copium.providers.base import Provider
...
class CopiumChatMessageHistory(BaseChatMessageHistory):
    ...
    Example:
        ...
        compressed = CopiumChatMessageHistory(
            base,
    ...
    def __init__(
        ...
        """Initialize CopiumChatMessageHistory.
        ...
        Args:
            ...
            model: Model name for token counting. Default "gpt-4o".
            provider: Copium provider for token counting. Auto-uses
    ...
    def messages(self) -> list[BaseMessage]:  # type: ignore[override]
        ...
        logger.info(
            f"CopiumChatMessageHistory compressed: {token_count} -> {tokens_after} tokens "
    ...
    def _apply_compression(self, messages: list[BaseMessage]) -> list[BaseMessage]:
        ...
        Returns:
            ...
            applicable.
        """
        # Convert to OpenAI format for Copium transforms
