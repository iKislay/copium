...
Example:
    ...
    from copium.integrations import CopiumChatModel, StreamingMetricsTracker
...
class StreamingMetricsTracker:
    ...
    def __init__(
        ...
        Args:
            ...
            provider: Copium provider for token counting. Uses
...
class StreamingMetricsCallback:
    ...
    def __init__(self, model: str = "gpt-4o", provider: Any = None):
        ...
        Args:
            model: Model name for token counting.
            provider: Copium provider for token counting.
        """
