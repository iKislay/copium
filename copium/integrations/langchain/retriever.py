...
This module provides CopiumDocumentCompressor, a LangChain BaseDocumentCompressor
...
class CopiumDocumentCompressor(BaseDocumentCompressor):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        """Initialize CopiumDocumentCompressor.
    ...
    def compress_documents(
        ...
        logger.info(
            f"CopiumDocumentCompressor: {len(documents)} -> {len(final_docs)} documents "
