"""Canonical Copium pipeline lifecycle and extension contracts."""
...
ENTRY_POINT_GROUP = "copium.pipeline_extension"


class PipelineStage(str, Enum):
    """Stable lifecycle stages for the canonical Copium pipeline."""
