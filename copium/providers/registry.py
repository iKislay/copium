...
from copium.providers.claude import DEFAULT_API_URL as DEFAULT_ANTHROPIC_API_URL
from copium.providers.codex import DEFAULT_API_URL as DEFAULT_OPENAI_API_URL
from copium.providers.gemini import DEFAULT_API_URL as DEFAULT_GEMINI_API_URL
...
def _load_anyllm_backend() -> Any:
    ...
    if AnyLLMBackendType is None:
        from copium.backends.anyllm import AnyLLMBackend
...
def _load_litellm_backend() -> Any:
    ...
    if LiteLLMBackendType is None:
        from copium.backends.litellm import LiteLLMBackend
