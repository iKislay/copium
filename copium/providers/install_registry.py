...
from copium.providers.aider.install import build_install_env as _build_aider_install_env
from copium.providers.claude.install import (
...
from copium.providers.codex.install import (
    apply_provider_scope as _apply_codex_provider_scope,
)
from copium.providers.codex.install import build_install_env as _build_codex_install_env
from copium.providers.codex.install import (
    revert_provider_scope as _revert_codex_provider_scope,
)
from copium.providers.copilot.install import (
    build_install_env as _build_copilot_install_env,
)
from copium.providers.cursor.install import build_install_env as _build_cursor_install_env
