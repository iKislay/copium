...
from copium.providers.codex import proxy_base_url as codex_proxy_base_url
from copium.proxy.project_context import with_project_prefix
...
def build_launch_env(
    ...
    as a JSON array. When routing through Copium, we set the mistral provider's
    ...
    # NOTE: With a persistent Copium deployment (`copium install`), the proxy
    ...
    # Build the providers JSON with mistral provider pointing to Copium proxy
