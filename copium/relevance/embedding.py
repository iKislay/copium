"""Embedding-based relevance scorer for Copium SDK.
...
class EmbeddingScorer(RelevanceScorer):
    ...
    Note:
        Requires fastembed: pip install copium[relevance]
    """
    ...
    def _get_model(self) -> TextEmbedding:
        ...
        if not self.is_available():
            raise RuntimeError(
                "EmbeddingScorer requires fastembed. Install with: pip install copium[relevance]"
            )
