"""Main CopiumClient implementation for Copium SDK."""
...
class ChatCompletions:
    ...
    def __init__(self, client: CopiumClient):
        self._client = client
    ...
    def create(
        ...
        *,
        ...
        stream: bool = False,
        # Copium-specific parameters
        copium_mode: str | None = None,
        copium_cache_prefix_tokens: int | None = None,
        copium_output_buffer_tokens: int | None = None,
        copium_keep_turns: int | None = None,
        copium_tool_profiles: dict[str, dict[str, Any]] | None = None,
        # Pass through all other kwargs
        **kwargs: Any,
    ) -> Any:
        """
        Create a chat completion with optional Copium optimization.

        Args:
            model: Model name.
            messages: List of messages.
            stream: Whether to stream the response.
            copium_mode: Override default mode ("audit" | "optimize").
            copium_cache_prefix_tokens: Target cache-aligned prefix size.
            copium_output_buffer_tokens: Reserve tokens for output.
            copium_keep_turns: Never drop last N turns.
            copium_tool_profiles: Per-tool compression config.
        ...
        return self._client._create(
            ...
            messages=messages,
            stream=stream,
            copium_mode=copium_mode,
            copium_cache_prefix_tokens=copium_cache_prefix_tokens,
            copium_output_buffer_tokens=copium_output_buffer_tokens,
            copium_keep_turns=copium_keep_turns,
            copium_tool_profiles=copium_tool_profiles,
            api_style="openai",
            **kwargs,
        )
    ...
    def simulate(
        ...
        **kwargs: Any,
        ...
        Args:
            model: Model name.
            messages: List of messages.
            copium_mode: Mode to simulate.
            copium_output_buffer_tokens: Output buffer to use.
            copium_tool_profiles: Tool profiles to use.
...
class Messages:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        """
        Create a message with optional Copium optimization.
    ...
    def stream(
        ...
        **kwargs: Any,
        ...
        """
        Stream a message with optional Copium optimization.
...
class CopiumClient:
    ...
    def __init__(
        ...
        Args:
            ...
            config: Optional CopiumConfig for full control over all settings.
        ...
        self._default_mode = CopiumMode(default_mode)
    ...
    def _create(
        ...
        **kwargs: Any,
        ...
        mode = CopiumMode(copium_mode) if copium_mode else self._default_mode
        ...
        if mode == CopiumMode.OPTIMIZE:
            output_buffer = copium_output_buffer_tokens or self._config.output_buffer_tokens
            ...
            result = self._pipeline.apply(
                ...
                tool_profiles=copium_tool_profiles or {},
            )
    ...
    def __enter__(self) -> CopiumClient:
    ...
    def validate_setup(self) -> dict[str, Any]:
        """Validate that Copium is properly configured.
        ...
        try:
            # Check mode is valid
            if self._default_mode in (CopiumMode.AUDIT, CopiumMode.OPTIMIZE):
