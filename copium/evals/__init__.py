...
Install with: pip install copium-ai[evals]

Quick start:
    from copium.evals import run_quick_eval
    results = run_quick_eval(n_samples=5)
    print(results.summary())

Batch compression eval:
    from copium.evals import run_batch_compression_eval
...
from copium.evals.batch_compression_eval import (
...
from copium.evals.metrics import (
...
from copium.evals.runners.before_after import (
    BeforeAfterRunner,
    LLMConfig,
    run_quick_eval,
)
from copium.transforms.content_router import ContentRouterConfig
