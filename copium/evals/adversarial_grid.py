"""Adversarial robustness grid for Copium compressors (offline, no LLM).
...
- abuse compressor control surfaces. Copium has a concrete instance:
...
# Copium-specific CCR marker spoof. benign_control anchors the baseline.
