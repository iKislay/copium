"""Memory evaluation framework for Copium.
...
Example:
    from copium.evals.memory import LoCoMoEvaluator, MemoryEvalConfig
...
from copium.evals.memory.judge import (
...
from copium.evals.memory.runner import (
    LoCoMoEvaluator,
    MemoryEvalConfig,
    MemoryEvalResult,
...
from copium.evals.memory.runner_v2 import (
    EvalMetrics,
    LoCoMoEvaluatorV2,
    MemoryEvalConfigV2,
    MemoryEvalResultV2,
