...
survive proxy restarts and can be shared by multiple Copium frontends.
"""
...
COPIUM_SAVINGS_PATH_ENV_VAR = _paths.COPIUM_SAVINGS_PATH_ENV
DEFAULT_SAVINGS_DIR = ".copium"
...
def get_default_savings_storage_path() -> str:
    ...
    # Preserve legacy behavior: when COPIUM_SAVINGS_PATH is set we return
    ...
    env_path = os.environ.get(COPIUM_SAVINGS_PATH_ENV_VAR, "").strip()
    if env_path:
        return env_path
