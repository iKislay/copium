"""AWS Bedrock ``InvokeModel`` passthrough handler for CopiumProxy.
...
through Copium's catch-all and were forwarded verbatim — no compression.
...
class BedrockHandlerMixin:
    ...
    async def handle_bedrock_invoke(
        ...
        *,
        ...
        bypass = (
            _copium_bypass_enabled(request.headers)
