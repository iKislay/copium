...
`crates/copium-core/src/transforms/search_compressor.rs`. This module
...
class SearchCompressor:
    ...
    def _parse_search_results(self, content: str) -> dict[str, FileMatches]:
        ...
        from copium._core import parse_search_lines
    ...
    def _score_matches(
        ...
        """
        from copium.transforms.error_detection import PRIORITY_PATTERNS_SEARCH
