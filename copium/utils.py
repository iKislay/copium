"""Shared utilities for Copium SDK."""
...
# Marker format for Copium modifications
MARKER_PREFIX = "<copium:"
MARKER_SUFFIX = ">"
...
def extract_markers(text: str) -> list[dict[str, Any]]:
    """
    Extract Copium markers from text.

    Returns:
        List of dicts with marker_type and attributes.
    """
    pattern = re.compile(r"<copium:(\w+)([^>]*)>")
    markers = []
