...
class RuntimeKind(str, Enum):
    """Runtime used to execute Copium."""
...
class ManagedMutation:
    """A reversible change applied by `copium install`."""
...
class DeploymentManifest:
    ...
    image: str = "ghcr.io/iKislay/copium:latest"
    service_name: str = "copium"
    container_name: str = "copium-persistent"
