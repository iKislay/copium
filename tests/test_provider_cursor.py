...
from copium.providers.cursor import build_proxy_targets, render_setup_lines
from copium.providers.cursor.install import build_install_env


def test_cursor_proxy_targets_use_local_copium_proxy() -> None:
