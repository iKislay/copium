...
``copium mcp serve`` writes every compress / retrieve invocation to a
...
``copium_compress`` directly.

These tests pin the aggregation logic in
:func:`copium.proxy.cost._aggregate_mcp_events`.
"""
