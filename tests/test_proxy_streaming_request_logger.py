...
from copium.proxy.request_logger import RequestLogger
from copium.proxy.server import CopiumProxy


def _build_proxy_with_real_logger(*, log_full_messages: bool) -> CopiumProxy:
    """Build a CopiumProxy with mocks for everything except the request logger,
