...
def test_no_cost_without_copium_field():
    """cost_without_copium_usd should NOT be in stats (removed to avoid confusion)."""
    from copium.proxy.server import CostTracker
    ...
    assert "cost_without_copium_usd" not in stats
