...
Tests cover:
1. CopiumChatMessageHistory - Wrapper for chat message history with compression
...
class TestCopiumChatMessageHistoryInit:
    """Tests for CopiumChatMessageHistory initialization."""
    ...
    def test_init_defaults(self, mock_base_history):
        ...
        with patch("copium.integrations.langchain.memory.OpenAIProvider"):
            history = CopiumChatMessageHistory(mock_base_history)
...
class TestCopiumChatMessageHistoryMessages:
    ...
    def test_messages_returns_empty_when_no_messages(self, mock_base_history, mock_provider):
        ...
        history = CopiumChatMessageHistory(mock_base_history, provider=mock_provider)
...
class TestCopiumChatMessageHistoryAddMessage:
...
class TestCopiumChatMessageHistoryConversion:
...
class TestCopiumChatMessageHistoryTokenCounting:
...
class TestCopiumChatMessageHistoryStats:
...
class TestCopiumChatMessageHistoryCompression:
    ...
    def test_apply_compression_calls_pipeline(self, mock_base_history, mock_provider):
        ...
        with patch("copium.integrations.langchain.memory.TransformPipeline") as MockPipeline:
...
class TestLangChainNotAvailable:
    ...
    def test_check_raises_import_error(self):
        ...
        from copium.integrations.langchain.memory import _check_langchain_available
