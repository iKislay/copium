"""Comprehensive tests for Copium's memory system.
...
from copium.memory.adapters.graph_models import (
    Entity,
    Relationship,
...
from copium.memory.ports import MemorySearchResult as PortsMemorySearchResult
from copium.memory.system import MemorySearchResult, MemorySystem
from copium.memory.tools import MEMORY_TOOLS, get_memory_tools, get_tool_names
...
class TestSubgraphToContext:
    ...
    def test_to_context_empty_subgraph(self):
        ...
        from copium.memory.ports import Subgraph as PortsSubgraph
    ...
    def test_to_context_entities_only(self):
        ...
        from copium.memory.ports import Entity as PortsEntity
        from copium.memory.ports import Subgraph as PortsSubgraph
    ...
    def test_to_context_with_relationships(self):
        ...
        from copium.memory.ports import Entity as PortsEntity
        from copium.memory.ports import Relationship as PortsRel
        from copium.memory.ports import Subgraph as PortsSubgraph
