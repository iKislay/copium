...
def get_tracked_memory() -> dict:
    ...
    from copium.memory.tracker import MemoryTracker
...
class TestMemorySystemIntegration:
    ...
    async def test_graph_store_memory_growth(self):
        ...
        from copium.memory.adapters.graph_models import Entity, Relationship
        from copium.memory.tracker import MemoryTracker
...
class TestCCRIntegration:
    ...
    def reset_stores(self):
        ...
        from copium.ccr.batch_store import reset_batch_context_store
        from copium.memory.tracker import MemoryTracker
    ...
    def test_batch_context_store_memory_growth(self):
        ...
        from copium.ccr.batch_store import (
            BatchContext,
            BatchContextStore,
            BatchRequestContext,
        )
...
class TestProxyMemoryIntegration:
    ...
    def test_real_api_calls_memory_tracking(self, api_key):
        ...
        from copium.cache.compression_store import CompressionStore
        from copium.ccr.batch_store import BatchContextStore
...
class TestCombinedMemoryTracking:
    ...
    async def test_all_components_memory_tracking(self):
        ...
        from copium.cache.compression_store import CompressionStore
        from copium.ccr.batch_store import BatchContext, BatchContextStore, BatchRequestContext
        from copium.memory.adapters.graph import InMemoryGraphStore
        from copium.memory.adapters.graph_models import Entity, Relationship
        from copium.memory.adapters.hnsw import HNSWVectorIndex
        from copium.memory.models import Memory
