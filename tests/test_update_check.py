"""Tests for copium.update_check (PyPI probe, cache, banner notice)."""
...
def test_notice_when_newer(monkeypatch):
    ...
    assert notice and "0.27.0" in notice and "copium update" in notice
