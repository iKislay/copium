...
from copium.proxy.memory_handler import MemoryConfig, MemoryHandler, MemoryMode
...
def test_tool_mode_skip_emits_structured_log(caplog: Any) -> None:
    ...
    ``copium.propagate=False`` and attaches a file handler. The conftest
    ...
    target_logger = logging.getLogger("copium.proxy.memory_handler")
