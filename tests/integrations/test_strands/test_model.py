"""Real-world integration tests for Strands CopiumStrandsModel.
...
# ============================================================================
# Test Class for CopiumStrandsModel
# ============================================================================


@pytest.mark.skipif(SKIP_BEDROCK, reason="AWS credentials not available")
@pytest.mark.skipif(not STRANDS_AVAILABLE, reason="strands-agents not installed")
class TestCopiumStrandsModelReal:
    """Real-world integration tests for CopiumStrandsModel with Bedrock."""
    ...
    def wrapped_model(self, base_bedrock_model):
        """Create a CopiumStrandsModel wrapping the Bedrock model."""
    ...
    def test_model_wrapper_basic_response(self, wrapped_model):
        ...
        result = agent("Say 'Hello, Copium!' and nothing else.")
    ...
    def test_model_wrapper_custom_config(self, base_bedrock_model):
        """Test that custom CopiumConfig is applied."""
        from copium import CopiumConfig
        from copium.integrations.strands import CopiumStrandsModel

        custom_config = CopiumConfig()
        ...
        assert wrapped.copium_config is custom_config
        assert wrapped.copium_config.smart_crusher.min_tokens_to_crush == 50
    ...
    def test_model_wrapper_provider_detection(self, base_bedrock_model):
        ...
        assert wrapped._copium_provider is not None
        assert isinstance(wrapped._copium_provider, AnthropicProvider)
