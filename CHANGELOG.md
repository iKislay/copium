...
## [0.27.0](https://github.com/iKislay/copium/compare/v0.26.0...v0.27.0) (2026-07-16)


### Features

* add __iter__ and __getitem__ to SessionArchive ([be6db87](https://github.com/iKislay/copium/commit/be6db87aec594cb424f26d63f8286193279089fa))
* add --agent option to session compact command ([560c316](https://github.com/iKislay/copium/commit/560c3168442c54bff78b7136c3a16624eb247e02))
...
* add Aider JSONL/markdown session adapter ([cdbf756](https://github.com/iKislay/copium/commit/cdbf756620bee395c1b60d72bb6376661e962ce6))
* add ANSI remover Rust port (zero-allocation fast path) ([f859936](https://github.com/iKislay/copium/commit/f8599360361d8e93dd0a16df2a05f569115f8d7f))
* add ANSIRemover transform for terminal decoration stripping ([219a00b](https://github.com/iKislay/copium/commit/219a00bb2e644aa54c12013cb75e39830249ec88))
* add ANSIRemoverConfig to CopiumConfig ([4180c5d](https://github.com/iKislay/copium/commit/4180c5d6b10aaf9b921e395d4f0f31396f0e8165))
...
* add build error grouping, Docker compression, compiler normalization ([2eba512](https://github.com/iKislay/copium/commit/2eba5126f4e1865081735e67823ebca57032658c))
* add build/Docker/compiler config options to ErrorCompressorConfig ([d3a0e4d](https://github.com/iKislay/copium/commit/d3a0e4d062d6f5d1c8d9d0f5b4051313deefc501))
...
* add Claude Code JSONL session adapter ([7ceb6ab](https://github.com/iKislay/copium/commit/7ceb6abe8dd277e9b83670ab80f1a6d720aad4f8))
...
* add compressed memory store for agent workflows ([1bd66c6](https://github.com/iKislay/copium/commit/1bd66c625fcbb2fe92348b17c0bd7eb4304e1859))
* add compression diff visualization engine ([3ca903d](https://github.com/iKislay/copium/commit/3ca903deceba2ac43662c6adf570b3b4f0440d4b))
...
* add ContextCrumb comparison benchmark suite ([52c60b3](https://github.com/iKislay/copium/commit/52c60b35cf39e3a9e06d42174109f568d264e42c))
...
* add Cursor conversation JSON session adapter ([472f10d](https://github.com/iKislay/copium/commit/472f10d715e61971d99c537dee3874758572057a))
* add detect_format() to SessionArchive ([b483d3f](https://github.com/iKislay/copium/commit/b483d3f0eeeafa06a2a1c09a8a7dc405334ba7cc))
...
* add enable_session_archive flag to ContentRouter config ([ef76288](https://github.com/iKislay/copium/commit/ef76288c3308bc4df0f292a8ca92e7c5864d18c4))
...
* add FTS5-powered session search across all archives ([5ab9814](https://github.com/iKislay/copium/commit/5ab9814aa9577309f007ef7a74b5d31832fd11c0))
...
* add OpenCode (Go) session adapter ([8328f8e](https://github.com/iKislay/copium/commit/8328f8e458a544b578f8ab99b69b5c8eb2e1861e))
...
* add position-aware compression module skeleton (Rust) ([ca4afe0](https://github.com/iKislay/copium/commit/ca4afe02a11e44c954b37006e6084dc569869832))
* add position-aware reordering to SmartCrusher planner ([bf43d06](https://github.com/iKislay/copium/commit/bf43d0687d28b84e2665e4da6f786eed1ea492e2))
...
* add Python position-aware compression module ([26c2b89](https://github.com/iKislay/copium/commit/26c2b89719c6fe604f1d471977341d74eb6f1506))
...
* add Rust build error grouper with path normalization ([a2e9f7a](https://github.com/iKislay/copium/commit/a2e9f7a02762a785291f3da70b01a1e75f8ed652))
* add Rust session module with types and CompactResult ([03cbb27](https://github.com/iKislay/copium/commit/03cbb279b32d837fd4fdd6e8811a54eab4bcd48b))
...
* add session adapter protocol and registry ([967e9c0](https://github.com/iKislay/copium/commit/967e9c08b8a65c71822ba2451e8ac4249df68222))
* add session diff and stats CLI commands ([6af85de](https://github.com/iKislay/copium/commit/6af85de79f365ee0c86105d85bcb1a0ce2781c3a))
* add session export/import for cross-agent context sharing ([e2a86ff](https://github.com/iKislay/copium/commit/e2a86ff7b6a38d0ed854f51988922d91937c7f3e))
* add session replay command (experimental) ([5951499](https://github.com/iKislay/copium/commit/59514992a3bdf6e4f25b99f9b87f3f7cf134e88f))
* add session search and index CLI commands ([f93330a](https://github.com/iKislay/copium/commit/f93330a65e283cdabb3a14a6b3a141350dfe85e5))
...
* add tool response compressor for MCP proxy ([fefe719](https://github.com/iKislay/copium/commit/fefe7191828486479fa2929624e20a0533007a12))
...
* **agent-context:** add compression scheduler with phase pipelines ([6e9da49](https://github.com/iKislay/copium/commit/6e9da49bcf2b6a3843c06d082165c819665c02b0))
* **agent-context:** add context health monitor with metrics ([6ff1c6e](https://github.com/iKislay/copium/commit/6ff1c6e2934dd0f2bf2c023b7c83cb3bcb2ba949))
* **agent-context:** add context lifecycle manager ([b7ae621](https://github.com/iKislay/copium/commit/b7ae621951b5fbff49c07b36bc6c3d172af07af5))
* **agent-context:** add orientation cache to skip orientation tax ([8e12fc2](https://github.com/iKislay/copium/commit/8e12fc28f68035259f4257bb44f489febb73fc59))
* **agent-context:** add phase detector for agent session lifecycle ([b93cc74](https://github.com/iKislay/copium/commit/b93cc74a094f2c713a30123d2dbf0f3033984713))
* **agent-context:** add Smart Zone budget calculator ([6676c8f](https://github.com/iKislay/copium/commit/6676c8fceb13a7644e5bdc3f96716485b007b814))
* **agent-context:** add tool call classifier with value scoring ([90742de](https://github.com/iKislay/copium/commit/90742de805d3d1af460897c34ecee74210d177ff))
...
* **claude:** add settings guard helpers (env ledger, one-time backup, deleted-key restore) ([4cf8d46](https://github.com/iKislay/copium/commit/4cf8d46731e02267959e16485d50c6010c9f0953))
...
* **cli:** add 'copium mcp proxy' subcommands ([21ce899](https://github.com/iKislay/copium/commit/21ce899bdbcc95f1be35d23048dffc068d9bdb5f))
* **cli:** add 'copium quality' CLI commands ([1790e20](https://github.com/iKislay/copium/commit/1790e2089241c09b6b0dc1fe7ccdf105d59b752d))
...
* **cli:** add session restore and checkpoints commands ([ca1d684](https://github.com/iKislay/copium/commit/ca1d68464d3b58fd728fa31ff95165d06f42ab81))
...
* export ANSIRemover from transforms package ([a51140a](https://github.com/iKislay/copium/commit/a51140ac72521599d35bbc853183393e7baf602a))
* export SessionArchive, SessionCompactor, SessionSearch from copium ([4de9d4c](https://github.com/iKislay/copium/commit/4de9d4c7148a0d8b77570cf946160169dedaf8ff))
* export SessionSearch and SearchResult from session module ([edeb229](https://github.com/iKislay/copium/commit/edeb2296bd261cb6f9b9f1758db491a22857c276))
* expose strip_ansi as a public utility function ([39a457a](https://github.com/iKislay/copium/commit/39a457a4a136c694d6f1ede5b1f4957b9a13c7a7))
...
* **hooks:** add Claude Code hook integration module ([1923132](https://github.com/iKislay/copium/commit/1923132377add7e9775a4fd949c3e1f98b187f97))
* **hooks:** add entropy-based message scoring module ([a37915e](https://github.com/iKislay/copium/commit/a37915e6e7da22484f024da5328bd68ac82aa9b5))
* **hooks:** add incremental checkpointing transform ([18d65a3](https://github.com/iKislay/copium/commit/18d65a37b31da8d84546ea3e1f42e05c262ffd01))
* **hooks:** add pre-compaction hook data models and input-priority compression ([48c52fc](https://github.com/iKislay/copium/commit/48c52fcd0e098d67a3fb90430e34588981fc115b))
* **hooks:** export incremental checkpoint and all hook modules ([c82fb52](https://github.com/iKislay/copium/commit/c82fb52619394fec6cc264855bcf2a5744bbdcd8))
...
* implement position-aware compression and enhance agent context management documentation ([b79dee9](https://github.com/iKislay/copium/commit/b79dee978494fa0f4c295ad8c463ba9e430a0e21))
...
* integrate ANSIRemover into transform pipeline ([57b1886](https://github.com/iKislay/copium/commit/57b188650751f228adbd21ca642808b9facbd51a))
...
* integrate position-weighted scoring into anchor_selector ([c65b872](https://github.com/iKislay/copium/commit/c65b87208001ff7a60b719a9673c4dcd76064c9f))
* **integrations:** add Agno and Strands shared context support ([8a0df80](https://github.com/iKislay/copium/commit/8a0df80ab009feb503fa158867c7a276891a9de5))
* **integrations:** add AutoGen shared context middleware ([659d6e8](https://github.com/iKislay/copium/commit/659d6e8eda13f3a404835e325da3a1d78422a3f5))
* **integrations:** add CrewAI shared context integration ([b908baf](https://github.com/iKislay/copium/commit/b908baf07a7f9aaada8b8cc0da78fa6408866468))
* **integrations:** add LangGraph shared context nodes ([3a24c77](https://github.com/iKislay/copium/commit/3a24c77cb1d4ed5455b81b8ebf41045fb8d7234e))
* **integrations:** add OpenAI Agents SDK handoff integration ([021f393](https://github.com/iKislay/copium/commit/021f39350fedd1a1cd3933b048303e42dbcae5a9))
* **integrations:** expose local model integrations from top-level ([aef7863](https://github.com/iKislay/copium/commit/aef786386e6ecf614ab90ca8be77bfb869030378))
* **local:** add adaptive compression engine ([278cf0f](https://github.com/iKislay/copium/commit/278cf0f2bd77944f8efc89ad2adc553f0b3be66c))
* **local:** add llama.cpp server integration ([3ac9cb5](https://github.com/iKislay/copium/commit/3ac9cb57d143346043a869a7f9270055a116b66e))
* **local:** add LM Studio integration ([24d4e88](https://github.com/iKislay/copium/commit/24d4e8851f7d1b17db4c0f074792ec6a13c9195d))
* **local:** add local backend detection registry ([dec500d](https://github.com/iKislay/copium/commit/dec500db4e40e4649e76af3accb055a36422ec1a))
* **local:** add local triage engine for smart routing ([5192a97](https://github.com/iKislay/copium/commit/5192a97a327ed919359ca24bbc6ff753e3dbace8))
* **local:** add Ollama auto-detection and integration ([404e0a1](https://github.com/iKislay/copium/commit/404e0a1c2d4e3d1e864856feeeb399bd7a1159e1))
* **local:** add streaming compressor for low-memory environments ([a7d11b6](https://github.com/iKislay/copium/commit/a7d11b668da331f5fb733142d232005b213df60f))
* **local:** add VRAM monitor for GPU memory tracking ([a2e4a8b](https://github.com/iKislay/copium/commit/a2e4a8bf865231e67c5a98c2b65ae42cbe202515))
* **local:** add VRAM-constrained configuration presets ([1029fd4](https://github.com/iKislay/copium/commit/1029fd456f3d642ff0190ff678ce7f7d7513eaa3))
* **local:** update __init__.py with all local integration exports ([f7403a1](https://github.com/iKislay/copium/commit/f7403a1785efcbd184e7cb875de9843540fc5968))
* **mcp-proxy:** add agent detection and proxy installation ([9bdfeb0](https://github.com/iKislay/copium/commit/9bdfeb0b02b71b71eb82ade7937a4b11884da211))
* **mcp-proxy:** add main CopiumMCPProxy server ([4f51094](https://github.com/iKislay/copium/commit/4f51094e2c264240fc5140429f0d737cda4c9435))
* **mcp-proxy:** add observability and metrics collection ([b239a32](https://github.com/iKislay/copium/commit/b239a329965c2526e2bfa78a403ff4becf27bd07))
* **mcp-proxy:** add progressive tool disclosure engine ([68366c0](https://github.com/iKislay/copium/commit/68366c0728871ff9b6bf475c8dc01826b7e0dc73))
* **mcp-proxy:** add proxy configuration module ([99eb574](https://github.com/iKislay/copium/commit/99eb5740846b4218f0c879c0cedf72d1b83f7cf8))
* **mcp-proxy:** add response compressor with CCR store ([7e30517](https://github.com/iKislay/copium/commit/7e30517082cfbcafbfcc3c4923c7952d434822d5))
* **mcp-proxy:** add schema compressor for JSON schemas ([1bd1659](https://github.com/iKislay/copium/commit/1bd165963077df3d45f722e7cf5ec08d9a325551))
* **mcp-proxy:** add session-level deduplication engine ([b8af2e4](https://github.com/iKislay/copium/commit/b8af2e458ec70e9ad5acd293e9504acdb12f10b4))
* **mcp-proxy:** add tool description compressor ([5720e0c](https://github.com/iKislay/copium/commit/5720e0c2f3ebf443e1defb5792e3dee0e7dc65ba))
* **mcp-proxy:** add TTL-based proxy cache ([cb897bc](https://github.com/iKislay/copium/commit/cb897bcec2a1375638d58131c87610b31abf589e))
* **mcp-proxy:** add upstream MCP server manager ([ff17232](https://github.com/iKislay/copium/commit/ff1723295717fb53608c6ac6dbf6a2c2bc3fec15))
* **mcp-proxy:** export ProgressiveDisclosureEngine and Interceptor ([60e2c61](https://github.com/iKislay/copium/commit/60e2c6184ed82fdca3a7219cb682e6013cfb8aa5))
* **mcp-proxy:** initialize mcp_proxy package ([a80abd9](https://github.com/iKislay/copium/commit/a80abd96953b336d96ad766a81f9f86bd0ddfbf7))
...
* **observability:** add CompressionReport for tool output bloat metrics ([ff59ce0](https://github.com/iKislay/copium/commit/ff59ce0b7d87edb955e9677524ec8c856807a85e))
...
* **pipeline:** integrate ToolPrefilter and SelfCompressor into default pipeline ([54224f9](https://github.com/iKislay/copium/commit/54224f9016c43e70cd0da59ad14b54aec6c52445))
* **progressive-disclosure:** add BM25 search backend ([da87af2](https://github.com/iKislay/copium/commit/da87af2524074cd3457ed021d62736e83b0324dc))
* **progressive-disclosure:** add copium_find_tool and copium_call_tool meta-tools ([657896b](https://github.com/iKislay/copium/commit/657896b9d667d9b12e16f2ba1770f2357a1dc457))
* **progressive-disclosure:** add EagerLoadingPolicy ([23f51f9](https://github.com/iKislay/copium/commit/23f51f94e189c9eb8485b1a0bc3d2f43cf582069))
* **progressive-disclosure:** add ProgressiveDisclosureEngine ([4ea29e9](https://github.com/iKislay/copium/commit/4ea29e9c6c3d699a4e60b8a2ce360b61c9c86845))
* **progressive-disclosure:** add proxy request/response interceptor ([7c6468b](https://github.com/iKislay/copium/commit/7c6468b96ccbe098ae19fb89127ba01e79fab049))
* **progressive-disclosure:** add schema registry and config ([4dcba36](https://github.com/iKislay/copium/commit/4dcba36dca8ed0b607225b9b73d8e209ef10d64d))
* **progressive-disclosure:** add system prompt injection ([2b2e869](https://github.com/iKislay/copium/commit/2b2e869cbfcad67be2a574a5cf80e35e270c7139))
...
* **proxy:** export CompactionDetector, PreCompactHook, PostCompactRecovery ([67399dc](https://github.com/iKislay/copium/commit/67399dcf6ab67fc116d6bb54dc9ff876ee269427))
...
* **quality:** add A/B testing harness for compression quality ([1ec7114](https://github.com/iKislay/copium/commit/1ec7114ef425e0b2cb9ca55039ab3bace9992813))
* **quality:** add quality benchmark runner ([62ad93a](https://github.com/iKislay/copium/commit/62ad93aa9def0a9573019d4256dde66daed3909b))
* **quality:** add Quality Gate with post-compression validation ([4f5e45c](https://github.com/iKislay/copium/commit/4f5e45c1d71d9673dcc53c876d279c725e99c6ad))
* **quality:** add quality metrics - ROUGE-L, IPS, CWQ ([c7e6989](https://github.com/iKislay/copium/commit/c7e6989c2508d59f72f755b5b1a3ed751c0c5c51))
* **quality:** add quality preservation framework and CLI commands ([2ead99d](https://github.com/iKislay/copium/commit/2ead99d7f48e6ffa9a5de08e893b35132c4112f8))
* **quality:** add real-time quality dashboard ([1345abc](https://github.com/iKislay/copium/commit/1345abce798fdf46aaaaa2eec2fbd05dc59cf6a8))
* **quality:** export all quality modules from package __init__ ([e5ea9fa](https://github.com/iKislay/copium/commit/e5ea9fa196efb1d78ed988f1ba05a7db58ae063d))
* **recipes:** add 'anti-bloat' recipe for monorepo coding sessions ([7e3335e](https://github.com/iKislay/copium/commit/7e3335e80ac880de6d3f2799e76f752c952485fa))
* **search_compressor:** tune defaults for more aggressive filtering ([09210f9](https://github.com/iKislay/copium/commit/09210f97c0073f0f3237730a6bbf7b7f8e62f3ec))
...
* **session_dedup:** add per-tool dedup profiles for smarter near-duplicate detection ([993017c](https://github.com/iKislay/copium/commit/993017c609ececea96dd40b6c4ca97b59615bba6))
...
* **session:** add compaction detector for pre-compaction hooks ([2ad0964](https://github.com/iKislay/copium/commit/2ad0964299d3c9abdfd5b51632fa8b415abf3641))
* **session:** add post-compaction recovery module ([92ee1ec](https://github.com/iKislay/copium/commit/92ee1ec44f04c1dcc414945070e380ec042f37c3))
* **session:** add pre-compaction hook for state checkpointing ([8f60e2c](https://github.com/iKislay/copium/commit/8f60e2c34a26c741b734838cd4806ace6a633de5))
...
* **session:** export CCRStoreBridge protocol from session package ([5b9a718](https://github.com/iKislay/copium/commit/5b9a718bc92ebfc521e50f99351975ec7fd7dcb3))
* **session:** integrate CCR store bridge into session expander ([44749a1](https://github.com/iKislay/copium/commit/44749a117394f1b7904d8bc84659866022e1fc41))
* **shared-context:** add agent provenance tracking ([3cfbf06](https://github.com/iKislay/copium/commit/3cfbf0664a8fa709e9152e72867bf3c89316d6c1))
* **shared-context:** add audit log for enterprise compliance ([2839cd4](https://github.com/iKislay/copium/commit/2839cd46e8f19720fe05be99269ef97fe67a56b9))
* **shared-context:** add conflict resolution strategies ([4932c91](https://github.com/iKislay/copium/commit/4932c91d1f611d395382a7b5087d1a27e491e059))
* **shared-context:** add eviction policy manager ([494793d](https://github.com/iKislay/copium/commit/494793d27e04bfa075f07319737210ce2011973a))
* **shared-context:** add persistent=True mode to SharedContext ([a9b35cb](https://github.com/iKislay/copium/commit/a9b35cbff3ef6d4940d9e658fb94820b5b738329))
* **shared-context:** add PersistentSharedContext orchestrator ([cd35998](https://github.com/iKislay/copium/commit/cd3599888e83858f7145106a9ac11a0dec0efe06))
* **shared-context:** add serialization utilities ([8636bf5](https://github.com/iKislay/copium/commit/8636bf59e8fd32cb793d097aad043c932e6070cd))
* **shared-context:** add SQLite-backed persistent store ([7011bba](https://github.com/iKislay/copium/commit/7011bbafdd3091c7f759ccfbeb8a191738ced496))
* **shared-context:** add vector index for semantic search ([52f22d6](https://github.com/iKislay/copium/commit/52f22d6441e2cd23222aabbea4bd9c3bf209a68d))
...
* show detected agent format in session summary ([21cc8ef](https://github.com/iKislay/copium/commit/21cc8efce907d4c3091860a5e302b390ca49b01f))
* show grouped error count and files in error card markers ([b8abb57](https://github.com/iKislay/copium/commit/b8abb57800e32303dcb96f441a552afe9f1db320))
...
* **transforms:** add SelfCompressor for LLM self-compression markers ([5aca962](https://github.com/iKislay/copium/commit/5aca9623b05a743bc27c8867179d2f2ed7f55b1c))
* **transforms:** add ToolPrefilter for pre-filtering oversized tool outputs ([6ee9ad6](https://github.com/iKislay/copium/commit/6ee9ad6434fb73ad74eec6728369e453d0379f64))
* **transforms:** export SelfCompressor and ToolPrefilter from transforms package ([953d43d](https://github.com/iKislay/copium/commit/953d43db8ae95b5ed906747528743344287c3523))
...
* _estimate_input_cost_usd also needs fallback pricing ([bd6c07a](https://github.com/iKislay/copium/commit/bd6c07aa4804bae09c03f4934a8a3fb6a8df948e))
...
* **claude:** never delete user-owned ANTHROPIC_BASE_URL on unwrap ([e2b90bc](https://github.com/iKislay/copium/commit/e2b90bc4d2463217fd34e7997100d90beeb4546e))
...
* correct TransformResult construction in ANSIRemover ([770ed9b](https://github.com/iKislay/copium/commit/770ed9bc96873be54c7d76d5da6e55a8ec8671fa))
* CostTracker savings_usd also needs fallback when litellm unavailable ([6a30f2b](https://github.com/iKislay/copium/commit/6a30f2b6b983b6fec231662ff8df33b0c2273d55))
...
* dollars saved always showing $0 in dashboard ([1e1e7ee](https://github.com/iKislay/copium/commit/1e1e7ee3cbbc1ea631f039117e49067f8a3949fd))
* **hooks:** stop write_hook_settings(merge=False) wiping settings.json ([462da84](https://github.com/iKislay/copium/commit/462da84f2bcde068fb5480ff65a157345780c81f))
* **hooks:** unshadow the base hooks module so copium.hooks imports work ([5f472ce](https://github.com/iKislay/copium/commit/5f472ce5084eb764e60fb1dec2d94e89478a062a))
...
* preserve MCP servers when restoring opencode config on wrap/unwrap exit ([39e3cb0](https://github.com/iKislay/copium/commit/39e3cb0119afb6d0eeceeb925f1ca4a3a43973c4))
...
* remove SBOM from dist/ before PyPI upload ([a32b24d](https://github.com/iKislay/copium/commit/a32b24d433fe601b4cb7b80f232325c2b386a7df))
...
* resolve remaining borrow checker error in strip_all ([c824b39](https://github.com/iKislay/copium/commit/c824b3995a171873c96e5f319f3de676be9e814a))
...
* resolve Rust compilation errors in copium-core ([b0f9ed8](https://github.com/iKislay/copium/commit/b0f9ed8235f531dd7c3f693774a5786636406a22))
* **rtk:** guard settings.json against destructive external rtk init writes ([f979861](https://github.com/iKislay/copium/commit/f9798618dce7713923e05fa50f67793d4f321525))
* **rust:** add missing lazy_static dependency and fix import ([ba99d25](https://github.com/iKislay/copium/commit/ba99d25a147a3dea9014b61fde67fb3b59e8181f))
* skip SBOM release upload when not triggered by a tag ([be89462](https://github.com/iKislay/copium/commit/be89462b0779d9034334f22fdfad4de0a571ccde))
* unshadow shared_context module into package ([3f3c053](https://github.com/iKislay/copium/commit/3f3c053d1d9557de4254b0696d8d91fe7468658d))
* update cyclonedx-py flag --outfile to -o in publish workflow ([9b1071c](https://github.com/iKislay/copium/commit/9b1071ca73d1c1e69c3c7e6918b0e5bee76a51b8))
* use PYPI_API_TOKEN for publish workflow fallback ([06bfe3c](https://github.com/iKislay/copium/commit/06bfe3caef0de0423f07fd4ba44b977672dd45be))
* wrap CLI savings summary reading from wrong endpoint ([f5b7e94](https://github.com/iKislay/copium/commit/f5b7e94acddbc23f2d7fdb6af2c58f2a6e897f28))
