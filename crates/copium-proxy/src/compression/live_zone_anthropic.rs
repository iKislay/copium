...
//! [`copium_core::transforms::LiveZoneOutcome`] and the
...
//!    [`copium_core::transforms::compress_anthropic_live_zone`].
...
//! `crates/copium-core/tests/live_zone_dispatch.rs` pins the
//! SHA-256 prefix-and-suffix invariant in CI.

use bytes::Bytes;
use copium_core::auth_mode::AuthMode as RequestAuthMode;
use copium_core::transforms::live_zone::DEFAULT_MODEL;
