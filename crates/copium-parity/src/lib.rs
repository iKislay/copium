...
impl TransformComparator for DiffCompressorComparator {
    ...
    fn run(
        ...
        use copium_core::transforms::{DiffCompressor, DiffCompressorConfig};
...
/// `copium.providers.openai.OpenAITokenCounter("gpt-4o-mini")`, so the
...
impl TransformComparator for SmartCrusherComparator {
    ...
    fn run(
        ...
        use copium_core::transforms::smart_crusher::{SmartCrusher, SmartCrusherConfig};
...
impl TransformComparator for ContentDetectorComparator {
    ...
    fn run(
        ...
        use copium_core::transforms::detect_content_type;
