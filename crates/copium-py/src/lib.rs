//! PyO3 bindings for copium-core. Exposed to Python as `copium._core`.
//!
...
//! `copium.transforms._rust_diff_compressor.RustBackedDiffCompressor`,
...
/// Mirror of `copium.transforms.diff_compressor.DiffCompressorConfig`.
...
/// compatibility.
#[pyclass(name = "DiffCompressorConfig", module = "copium._core")]
#[derive(Clone)]
...
/// Mirror of `copium.transforms.diff_compressor.DiffCompressionResult`.
...
#[pyclass(name = "DiffCompressionResult", module = "copium._core")]
...
#[pyclass(name = "DiffCompressorStats", module = "copium._core")]
...
/// Mirror of `copium.transforms.diff_compressor.DiffCompressor`. The
/// Python adapter wraps this in `RustBackedDiffCompressor` so
/// `ContentRouter` can swap backends transparently.
#[pyclass(name = "DiffCompressor", module = "copium._core")]
...
/// Mirror of `copium.transforms.smart_crusher.SmartCrusherConfig`.
...
#[pyclass(name = "SmartCrusherConfig", module = "copium._core")]
#[derive(Clone)]
...
/// Mirror of `copium.transforms.smart_crusher.CrushResult`. Read-only;
...
#[pyclass(name = "CrushResult", module = "copium._core")]
...
/// Mirror of `copium.transforms.smart_crusher.SmartCrusher`.
///
...
#[pyclass(name = "SmartCrusher", module = "copium._core")]
    ...
    fn with_compaction_format(
        ...
        match RustSmartCrusher::with_compaction_format(cfg, format_name) {
            ...
            None => Err(pyo3::exceptions::PyValueError::new_err(format!(
                ...
                copium_core::transforms::smart_crusher::compaction::CompactionStage::SUPPORTED_FORMAT_NAMES.join(", ")
            ))),
        }
    }
...
/// Mirror of `copium.transforms.content_detector.DetectionResult`.
///
...
#[pyclass(name = "DetectionResult", module = "copium._core")]
#[derive(Clone)]
...
/// `copium/transforms/content_router.py`).
///
...
/// Score a line against the default Copium keyword detector.
///
...
//
// Mirrors `copium.transforms.search_compressor.SearchCompressor` so the
...
#[pyclass(name = "SearchCompressorConfig", module = "copium._core")]
#[derive(Clone)]
...
#[pyclass(name = "SearchCompressionResult", module = "copium._core")]
...
#[pyclass(name = "SearchCompressor", module = "copium._core")]
...
impl PySearchCompressor {
    ...
    fn compress(
        ...
        let (result, stats) = py.allow_threads(move || {
            let store = copium_core::ccr::InMemoryCcrStore::new();
            let (r, s) = self
                .inner
...
#[pyclass(name = "LogCompressionResult", module = "copium._core")]
...
#[pyclass(name = "LogCompressor", module = "copium._core")]
...
//
// Mirrors `copium.transforms.tag_protector.{protect_tags,restore_tags,
...
/// `crates/copium-proxy` binary would sit in front of Python; that
/// binary is not deployed by the CLI (`copium proxy`,
/// `copium wrap codex`). This binding lets the Python proxy call
...
///   to `copium_core::transforms::live_zone::DEFAULT_MODEL`.
///
/// # Returns
/// `(body, modified)`:
...
fn compress_openai_responses_live_zone(
    ...
    let model_str = if model.is_empty() {
        copium_core::transforms::live_zone::DEFAULT_MODEL
    } else {
        model
    };
