...
//!
//! 1. The Python `copium.cli.toin_publish` CLI walks the on-disk TOIN
...
/// not propagate.
pub const RECOMMENDATIONS_PATH_ENV_VAR: &str = "COPIUM_RECOMMENDATIONS_PATH";
...
///
/// Honors `COPIUM_RECOMMENDATIONS_PATH` for prod overrides; falls
