//! Unified-diff compressor — Rust port of `copium.transforms.diff_compressor`.
//!
...
/// Priority patterns matching `copium.transforms.error_detection.PRIORITY_PATTERNS_DIFF`:
...
/// `copium.cache.compression_store.CompressionStore.store`.
