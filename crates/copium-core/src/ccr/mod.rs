...
//! end-to-end.
//!
//! Mirrors the semantics of Python's [`CompressionStore`] (`copium/
...
//!
//! [`CompressionStore`]: https://github.com/iKislay/copium/blob/main/copium/cache/compression_store.py
...
pub fn compute_key(payload: &[u8]) -> String {
    ...
    // (`[a-f0-9]{24}`) — see `copium/ccr/tool_injection.py:211`.
...
/// calls `copium_retrieve`. Format is intentionally fixed across
