...
//!
//! Mirrors `MODEL_PATTERNS` in `copium/tokenizers/registry.py`. Three
...
///
/// Patterns and ordering match `copium.tokenizers.registry.MODEL_PATTERNS`
...
///
/// ```no_run
/// use copium_core::tokenizer::try_register_hf;
