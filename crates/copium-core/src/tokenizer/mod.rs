//! Token counting for Copium transforms.
//!
//! Mirrors the public surface of the Python `copium.tokenizers` package:
...
//!
//! # What this is NOT
//! - Not used by `copium-proxy` yet (Stage 2 is library-only; no production
//!   wiring).
