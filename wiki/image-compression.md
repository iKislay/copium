...
Copium automatically compresses images in your LLM requests, reducing token usage by **40-90%** while maintaining answer accuracy.
...
Copium's image compression uses a **trained ML router** to analyze your query and automatically select the optimal compression technique:
...
### With Copium Proxy (Zero Code Changes)
...
client = CopiumClient(provider="openai")
...
copium proxy --image-optimize

# Disable image compression
copium proxy --no-image-optimize
```
