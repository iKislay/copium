 ...
 */
import { withCopium as withCopiumOpenAI } from "copium-ai/openai";
import { withCopium as withCopiumAnthropic } from "copium-ai/anthropic";
...
async function main() {
  ...
  if (process.env.OPENAI_API_KEY) {
    ...
    const openai = withCopiumOpenAI(new OpenAI());
  ...
  if (process.env.ANTHROPIC_API_KEY) {
    ...
    const anthropic = withCopiumAnthropic(new Anthropic());
