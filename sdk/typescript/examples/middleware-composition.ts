 ...
 *
 * Combine copiumMiddleware with other Vercel AI SDK middlewares.
 * Copium compresses first, then other middlewares process the result.
 *
...
async function main() {
  ...
  const model = wrapLanguageModel({
    model: openai("gpt-4o"),
    middleware: [
      copiumMiddleware(), // compress large context
