...
about: Report results of testing `copium wrap copilot --subscription` on Linux/Windows/macOS
...
- **How you installed copium**: (pipx/pip `--pre` wheel · Docker install.sh/ps1 · built from source)
- **copium version**: (`copium --version`)
...
(logs from `~/.copium/logs/proxy.log`, surprises, etc.)
