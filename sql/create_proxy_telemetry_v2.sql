...
-- This table matches every field the beacon code writes in copium/telemetry/beacon.py
...
CREATE INDEX IF NOT EXISTS idx_ptv2_version ON proxy_telemetry_v2(copium_version);
