...
def main() -> None:
    ...
    versions = {
        ...
        "plugins/copium-agent-hooks/.claude-plugin/plugin.json": _read_json_version(
            ROOT / "plugins/copium-agent-hooks/.claude-plugin/plugin.json"
        ),
        "plugins/copium-agent-hooks/.github/plugin/plugin.json": _read_json_version(
