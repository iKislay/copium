...
Copium integrates with [Agno](https://github.com/agno-agi/agno) (formerly Phidata) to compress context for AI agents. Wrap any Agno model for automatic optimization, and use hooks for observability.

## Installation

```bash
pip install "copium-ai[agno]" agno
```
...
claude_model = CopiumAgnoModel(Claude(id="claude-sonnet-4-20250514"))
